...
::
   ...
   <domain>
     ...
     <launchSecurity type='tdx'>
       ...
       <quoteGenerationService type='vsock' cid='xxx' port='xxx'/>
     ...
   </domain>
...
``quoteGenerationService``
   ...
   Service(QGS) related configuration. This subelement includes a ``type``
   attribute to determine the socket type chosed, it can be "inet", "unix",
   "vsock" or "fd". Different ``type`` further determines other optional
   atributes supported. QGS is a daemon running on the host. User in TD guest
   cannot get TD quoting for attestation if QGS is not provided.
